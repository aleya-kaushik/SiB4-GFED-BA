        !COMPILER-GENERATED INTERFACE MODULE: Fri Sep 26 16:46:50 2025
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE EQUIPOOLS_RESTART_CONTINUE__genmod
          INTERFACE 
            SUBROUTINE EQUIPOOLS_RESTART_CONTINUE(PNUM,POOLPFT_END,     &
     &POOLPFT_EQUIB,POOLPFT_FLAY,POOLPFT_OUT)
     ...
     &          SPINUP
          ...
          END INTERFACE 
        END MODULE EQUIPOOLS_RESTART_CONTINUE__genmod
