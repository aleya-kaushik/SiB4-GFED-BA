...
! tested this conversion in the firegfed_read_* files: results in values too low
   ...
   do l=1,ntpft
      ...
      sibg%l(myl)%poollt%loss_fire_lay(lp,1) = myemis
      sibg%l(myl)%poollt%loss_transf_lay(lp,1) = mytrans
      sibg%l(myl)%poollt%poolpft_dloss(lp,1) = &
           sibg%l(myl)%poollt%poolpft_dloss(lp,1) &
           + mymort
      ...
      sibg%l(myl)%poollt%loss_transf_lay(lpc13,1) = &
           sibg%l(myl)%poollt%rcpoolpft_lay(lpc13,1)*mytrans
      ...
      sibg%l(myl)%poollt%loss_fire_lay(wp,1) = myemis
      sibg%l(myl)%poollt%loss_transf_lay(wp,1) = mytrans
      sibg%l(myl)%poollt%poolpft_dloss(wp,1) = &
           sibg%l(myl)%poollt%poolpft_dloss(wp,1) &
           + mymort
      ...
      sibg%l(myl)%poollt%loss_transf_lay(wpc13,1) = &
           sibg%l(myl)%poollt%rcpoolpft_lay(wpc13,1)*mytrans
      ...
      sibg%l(myl)%pooldt%loss_fire_lay(metlp,1) = myemis
      sibg%l(myl)%pooldt%loss_transf_lay(metlp,1) = mytrans
      sibg%l(myl)%pooldt%poollu_dloss(metlp,1) = &
           sibg%l(myl)%pooldt%poollu_dloss(metlp,1) &
           + mymort
      ...
      sibg%l(myl)%pooldt%loss_transf_lay(metlpc13,1) = &
           sibg%l(myl)%pooldt%rcpoollu_lay(metlpc13,1)*mytrans
      ...
      sibg%l(myl)%pooldt%loss_fire_lay(strlp,1) = myemis
      sibg%l(myl)%pooldt%loss_transf_lay(strlp,1) = mytrans
      sibg%l(myl)%pooldt%poollu_dloss(strlp,1) = &
           sibg%l(myl)%pooldt%poollu_dloss(strlp,1) &
           + mymort
      ...
      sibg%l(myl)%pooldt%loss_transf_lay(strlpc13,1) = &
           sibg%l(myl)%pooldt%rcpoollu_lay(strlpc13,1)*mytrans
      ...
      sibg%l(myl)%pooldt%loss_fire_lay(cdbp,1) = myemis
      sibg%l(myl)%pooldt%loss_transf_lay(cdbp,1) = mytrans
      sibg%l(myl)%pooldt%poollu_dloss(cdbp,1) = &
           sibg%l(myl)%pooldt%poollu_dloss(cdbp,1) &
           + mymort
      ...
      sibg%l(myl)%pooldt%loss_transf_lay(cdbpc13,1) = &
           sibg%l(myl)%pooldt%rcpoollu_lay(cdbpc13,1)*mytrans
      ...
      sibg%l(myl)%poollt%loss_fire_lay(pp,1) = myemis
      sibg%l(myl)%poollt%loss_transf_lay(pp,1) = mytrans
      sibg%l(myl)%poollt%poolpft_dloss(pp,1) = &
           sibg%l(myl)%poollt%poolpft_dloss(pp,1) &
           + mymort
      ...
      sibg%l(myl)%poollt%loss_transf_lay(ppc13,1) = &
           sibg%l(myl)%poollt%rcpoolpft_lay(ppc13,1)*mytrans
      ...
      DO s=1,nsoil 
         ...
         sibg%l(myl)%poollt%loss_transf_lay(frp,s) = &
              mytrans * sibg%l(myl)%poollt%poolpft_flay(frp,s)
      ...
      DO s=1,nsoil 
         ...
         sibg%l(myl)%poollt%loss_transf_lay(crp,s) = &
              mytrans * sibg%l(myl)%poollt%poolpft_flay(crp,s)
      ...
      DO s=1,nsoil 
        ...
        sibg%l(myl)%pooldt%loss_transf_lay(slitp,s) = &
             mytrans * sibg%l(myl)%pooldt%poollu_flay(slitp,s)
      ...
      DO s=1,nsoil 
         ...
         sibg%l(myl)%pooldt%loss_transf_lay(slowp,s) = &
              mytrans * sibg%l(myl)%pooldt%poollu_flay(slowp,s)
      ...
      DO s=1,nsoil 
         ...
         sibg%l(myl)%pooldt%loss_transf_lay(armp,s) = &
              mytrans * sibg%l(myl)%pooldt%poollu_flay(armp,s)
     ...
     do j=npoollu/2+1,npoollu !(7,12) npoollu dead pools
      ...
      sibg%l(myl)%poollt%resp_fire = curemis
      sibg%l(myl)%poollt%resp_firec13 = curemisc13
