...
type, public :: co2_type
     ...
     real(r8) :: assimn  ! net assimilation (mol C/m2/s)
...
type, public :: poold_type
     ...
     !Fire Gain
     real(r8), dimension(:,:), allocatable :: &  !(npoollu,nsoil)
            gain_transf_lay  !gain from fire transfer based on mortality frac (mol C/m2/s)   
     ...
     real(r8), dimension(:,:), allocatable :: &  !(npoollu,nsoil)
           loss_transf_lay  !loss from transfer based on mortality frac (mol C/m2/s)     
...
type, public :: pooll_type
    ...
    !====Live Pool Gains (lpg, per timestep)====!
     ...
     real(r8) :: resp_grzc13 !grazing respiration for C-13 (mol C/m2/s)
     ...
     real(r8) :: resp_hrvstc13 !C harvest respiration for C-13 (mol C/m2/s)
     real(r8) :: rmvd_hrvst !C harvested and removed (mol C/m2)
     real(r8) :: rmvd_hrvstc13 !C harvested and removed (mol C/m2)
...
type, public :: gprog_type
    ...
    !...burned area variables for each PFT
    real(r8) :: ba_dbg   
    real(r8) :: ba_en2     
    real(r8) :: ba_en3 
    real(r8) :: ba_dnf    
